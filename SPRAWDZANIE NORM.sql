...
SET @INDEKS = '565-T0K-50' -- TUTAJ WPISZ INDEKS--;
...
,[Primary Key Field 3 Value] AS [Salon]
	...
	FROM
		[sql2].[Kr].[dbo].[KR$Change Log Entry] WITH (NOLOCK)
		WHERE [Table No_] = '100122006' AND [Primary Key Field 1 Value] = @INDEKS AND [Field No_] NOT IN (1,2,3,5,9,21,23,26,27,28,29,30,31,50001)
